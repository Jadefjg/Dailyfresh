...
class RegisterView(View):
    ...
    def post(self, request):
        ...
        # 发邮法2：用Django的 send_mail 函数
        # send_mail(subject, message, sender, receiver, html_message=html_message)

        # 发邮法3：celery 为处理者分配任务。异步任务，节约等待时间
...
class UserSiteView(LoginRequiredMixin, View):
    ...
    def get(self, request):
        ...
        # 使用模板
        return render(request, 'df_user/user_center_site.html', {'address': address, 'user': user})
    ...
    def post(self, request):
        ...
        if not re.match(r'^1[3|4|5|7|8][0-9]{9}$', phone):
            return render(request, 'df_user/user_center_site.html', {'errmsg': '手机格式错误'})
